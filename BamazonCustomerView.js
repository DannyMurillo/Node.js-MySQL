...
var connection = mysql.createConnection({
  ...
  // unsername 
  user: "root",
  // password if you have one for mysqlpro
  password: "",
  database: "Bamazon"
})

function start(){
//display items for sale and info
    ...
    },
    {
      ...
      if(res[whatToBuy].StockQuantity >= howMuchToBuy){
        ...
        {ItemID: ans.id}
            ...
            if(err) throw err;
            console.log("Your total is $" + grandTotal.toFixed(2) + ". Your item(s) will be shipped to you in 2 business days.");
        });
